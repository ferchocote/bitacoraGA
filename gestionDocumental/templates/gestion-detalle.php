          ...
          <?php foreach ($porFecha as $fecha => $docs): ?>
            <?php foreach ($docs as $doc): ?>
              <tr>
                ...
                <td>
                  <a href="/wp-content/gestionDocumental/controllers/descargar_documento.php?id=<?= esc_attr($doc->RutaArchivo) ?>" target="_blank" title="Ver/Descargar" onclick="showLoader()">
