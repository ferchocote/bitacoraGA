...
<body>
    <div class="form-container">
        ...
        <?php endif; ?>
        <form method="post" class="form-grid" action="" id="formNuevaGestion"<?= !empty($suscripcionBloqueada) ? ' onsubmit="return false;"' : '' ?>>
            <div class="form-group">
                <label for="importador">Importador:</label>
                <select name="importador" id="importador" required<?= !empty($suscripcionBloqueada) ? ' disabled' : '' ?>>
            ...
            <div class="form-buttons">
                ...
                <button type="submit" class="btn" id="btnCrearGestion"<?= !empty($suscripcionBloqueada) ? ' disabled title="' . esc_attr($mensajeSuscripcion) . '"' : '' ?>>Crear Gestión</button>
            </div>
